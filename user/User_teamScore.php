...
<head>
    ...
    <link rel = "stylesheet" href = "../user_style/user_teamScore.css">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalLabel">View Score</h1>
            ...
            function DisplayTeamScoreASC(searchValue) { //for ASC
                ...
                //funtion to sort by date
                    ...
                    function viewScore(id){
                                ...
                                $.post("../ajax/user_ajax.php", { view_score_id: id }, function(data, status) {
